...
Below pictures are the custom-designed components (screw holders), which were designed by using SolidWorks. These holders can stabilize the motion of screws when stepper motors are functioning. The component files can be found in Solidworks folder. [SolidWorks Folder](Solidworks)
